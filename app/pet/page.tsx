...
const TIPS = [
  { emoji: "📦", title: "Variables", code: `repas = 40\nnourrir(repas)\njouer("foot")` },
  { emoji: "🔁", title: "Boucle for", code: `for i in range(3):\n    jouer("balle")\netat()` },
  { emoji: "🔧", title: "Fonction", code: `def soiree():\n    nourrir(60)\n    danser()\n    dormir(7)\nsoiree()` },
];
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400 max-w-md mx-auto">
            Contrôle-le avec du Python — variables, boucles et fonctions prennent vie en temps réel !
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-800/50 rounded-2xl border border-slate-700 p-6">
            ...
            <p className="mt-4 text-[11px] text-gray-600 text-center">
              💡 Les skins achetés dans la{" "}
              <a href="/shop" className="text-cyan-500 hover:underline">boutique</a>{" "}
              changent l&apos;aura de ton robot
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              {pyodideReady
                ? "✅ Python prêt — nourrir() jouer() dormir() danser() etat() sont disponibles"
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
          {TIPS.map(({ emoji, title, code }) => (
            <div key={title} className="bg-slate-800/40 border border-slate-700 rounded-xl p-4">
