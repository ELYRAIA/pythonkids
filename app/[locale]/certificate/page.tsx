    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex flex-col items-center py-10 px-4">
      ...
      >
        ...
        <div className="border-t border-b border-purple-100 dark:border-purple-800 py-5 mb-6">
          ...
          <p className="text-base text-gray-600 dark:text-slate-300">{t("certifies")}</p>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          {[
            { emoji: "🏅", value: `${badgesToShow.length}`, label: t("badges_earned") },
            { emoji: "🎯", value: `${challengeCount}`, label: t("challenges_completed") },
            { emoji: "📅", value: completionDate, label: t("date_issued") },
          ].map((s) => (
        ...
        {badgesToShow.length > 0 && (
          <div className="mb-6">
            <p className="text-xs text-gray-400 dark:text-slate-500 uppercase tracking-wider mb-3">{t("earned_badges")}</p>
